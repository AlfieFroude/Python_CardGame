...
def play():
    ...
    global players_hand
    players_hand = []
    print("You have been delt 2 cards:")
    deal_hand()

def deal_hand():
    initial_deal_amount = 2
    for i in range(initial_deal_amount):
        card_delt = one_shuffled_deck(1)
        print(card_delt)
        players_hand.append(card_delt)
        #the peramiter inputted is the number of cards delt initially in blackjack
